...
#include "dif/rv_iommu_tests.h"
#include "dif/page_tables.h"
#include "params.h"
...
static iommu_t *iommu = (void*)&__base_iommu;
...
{
    return read64((uintptr_t)&iommu->msi_cfg_tbl[msi_tlb_entry].addr);
}
